...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def test(self, setting, test=0):
        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark, batch_cycle) in enumerate(test_loader):
                ...
                if i % 20 == 0:
                    ...
                    gt = np.concatenate((input[2, :, -1], true[2, :, -1]), axis=0)
                    pd = np.concatenate((input[2, :, -1], pred[2, :, -1]), axis=0)
        ...
        f.write(setting + "  \n")
        f.write('mse:{}, mae:{}, rmse:{}, mape:{}, alpha1:{}, alpha2:{}, patch:{}, dropout:{}, d2:{}, learning_rate:{}'.format(mse, mae, rmse, mape, self.args.alpha1, self.args.alpha2, self.args.patch, self.args.dropout, self.args.d2, self.args.learning_rate))
        f.write('\n')
        f.write('\n')
        f.close()
